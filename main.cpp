...
#define WINDOW_NAME		"大捕り物"	// ウインドウのキャプション名
...
//int g_Mode = MODE_NAMESELECT;					// 起動時の画面を設定
//=============================================================================
// メイン関数
//=============================================================================
...
void Update(void)
{
	...
	case MODE_NAMESELECT:		// セレクト画面の更新
		UpdateNameselect();
		break;
...
void Draw(void)
{
	...
	case MODE_NAMESELECT:		// セレクト画面の描画
		SetViewPort(TYPE_FULL_SCREEN);
