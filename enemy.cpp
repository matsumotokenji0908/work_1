...
// マクロ定義
//*****************************************************************************
#define	MODEL_ENEMY			"data/MODEL/enemy01.obj"		// 読み込むモデル名
...
static INTERPOLATION_DATA g_MoveTbl0[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(0.0f, ENEMY_OFFSET_Y,  20.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(-200.0f, ENEMY_OFFSET_Y,  10.0f), XMFLOAT3(0.0f, 6.28f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 1 },
	{ XMFLOAT3(-100.0f, ENEMY_OFFSET_Y, 200.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 0.5f },
	{ XMFLOAT3(1.0f, ENEMY_OFFSET_Y, -00.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 0.5f },

};

static INTERPOLATION_DATA g_MoveTbl1[] = {	// pos, rot, scl, frame

	{ XMFLOAT3(-20.0f, ENEMY_OFFSET_Y,  -200.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(-100.0f, ENEMY_OFFSET_Y,  20.0f), XMFLOAT3(0.0f, 6.28f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 1 },
	{ XMFLOAT3(-100.0f, ENEMY_OFFSET_Y, 500.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 0.5f },
...
static INTERPOLATION_DATA g_MoveTbl2[] = {	// pos, rot, scl, frame
	...
	{ XMFLOAT3(100.0f, ENEMY_OFFSET_Y,  50.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(500.0f, ENEMY_OFFSET_Y,  50.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f),60 * 2 },
	{ XMFLOAT3(175.0f, ENEMY_OFFSET_Y, -188.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(300.0f, ENEMY_OFFSET_Y,  148.0f), XMFLOAT3(0.0f, 6.28f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(425.0f, ENEMY_OFFSET_Y, -188.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
...
static INTERPOLATION_DATA g_MoveTbl3[] = {	// pos, rot, scl, frame
	...
	{ XMFLOAT3(-100.0f, ENEMY_OFFSET_Y,  50.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(30.0f, ENEMY_OFFSET_Y,  300.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f),60 * 2 },
	{ XMFLOAT3(75.0f, ENEMY_OFFSET_Y, -408.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(100.0f, ENEMY_OFFSET_Y,  248.0f), XMFLOAT3(0.0f, 6.28f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
	{ XMFLOAT3(405.0f, ENEMY_OFFSET_Y, -108.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.5f, 0.5f, 0.5f), 60 * 2 },
